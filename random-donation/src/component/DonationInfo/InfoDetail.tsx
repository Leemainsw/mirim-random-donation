    ...
    <InfoDetailWrapper>
      <DetailWrapper>
        ...
        <DetailWordWrapper>
          ...
          <DetailWord>2. 8900원에 너가 산 달력 개수를 곱한다.</DetailWord>
          <DetailWord>3. 거기에 선생님들 달력 값 1900원을 더한다.</DetailWord>
          <DetailWord>4. 거기에 랜덤으로 정해진 수고비를 더한다.</DetailWord>
        ...
        <DetailWordWrapper>
          <DetailWord>
            - 3만원 도네이션 당첨되면 애장품 증정 받을 수 있는 영광이 주어짐.
          </DetailWord>
          <DetailWord>- 3만원 도네이션 당첨되면 추가 식사권 증정.</DetailWord>
          <DetailWord>- 다른 사람 사칭한 거 들키면 벌칙 있습니다.</DetailWord>
        ...
        <DetailWordWrapper>
          ...
          <DetailWord>
            A. 밑에 체크박스에 <BoldWord>이름을 적으면 달력의 요정</BoldWord>이
            도네 금액을 정해줄 것임요.
          </DetailWord>
        </DetailWordWrapper>
